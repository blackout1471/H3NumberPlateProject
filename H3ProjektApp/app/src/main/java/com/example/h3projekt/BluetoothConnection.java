...
public class BluetoothConnection
{
    ...
    private static final String appName = "H3Projekt";
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run(){
            ...
            while (true) {
                ...
                try {
                    ...
                    Log.d(TAG, "InputStream incomming message: " + incomingMessage);
                } catch (IOException e) {
        ...
        public void cancel() {
            try {
                ...
                Log.e(TAG, "Problem canceling mmSocket in ConnectedThread");
            }
        }
    }
}
